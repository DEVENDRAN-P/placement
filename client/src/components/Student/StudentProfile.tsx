  ...
  return (
    <div>
      ...
      <p className="mt-2 text-gray-600">
        Build a verified career profile with academics, skills, projects, and coding profiles.Build a verified career profile with academics, skills, projects, and coding profiles.
      </p>
